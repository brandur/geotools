...
/* 
 * $Header: /cvsroot/geotoolsnet/GeotoolsNet/Geotools.UnitTests/Utilities/Compare.cs,v 1.4 2005/10/20 16:46:36 awcoats Exp $
 * $Log: Compare.cs,v $
 * Revision 1.4  2005/10/20 16:46:36  awcoats
 * *** empty log message ***
 *
 * 
...
namespace Geotools.UnitTests.Utilities
{
	...
	public class Compare
	{
		...
		public static bool CompareAgainstString(string filename, string compareString)
		{
			...
			string s1 = filestring.Trim().Replace("\r\n", "\n");
			string s2 = compareString.Trim().Replace("\r\n", "\n");
			return s1 == s2;
		}
