...
/* 
 * $Header: /cvsroot/geotoolsnet/GeotoolsNet/Geotools.UnitTests/CoordinateTransformation/CoordinateTransformationEPSGFactoryTest.cs,v 1.4 2005/10/20 16:30:07 awcoats Exp $
 * $Log: CoordinateTransformationEPSGFactoryTest.cs,v $
 * Revision 1.4  2005/10/20 16:30:07  awcoats
 * *** empty log message ***
 *
 * 
	...
	public class CoordinateTransformationEPSGFactoryTest
	{
		...
		public void TestCreateFromTransformationCode3()
		{
			try 
			{
				...
				Assertion.Fail("Exception should be thrown.");
			}
