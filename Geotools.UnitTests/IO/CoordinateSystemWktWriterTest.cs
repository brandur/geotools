...
/* 
 * $Header: /cvsroot/geotoolsnet/GeotoolsNet/Geotools.UnitTests/IO/CoordinateSystemWktWriterTest.cs,v 1.4 2005/10/20 16:36:12 awcoats Exp $
...
namespace Geotools.UnitTests
{
	...
	public class CoordinateSystemWktWriterTest 
	{
		...
		public void TestWriteCompoundCoordinateSystem() 
		{
			...
			bool same = Compare.CompareAgainstString(Global.GetUnitTestRootDirectory()+@"\IO\Testfiles\CompoundCoordinateSystem.txt", textwriter.ToString() );
		...
		public void TestWriteUnit2() 
		{
			...
			bool same = Compare.CompareAgainstString(Global.GetUnitTestRootDirectory()+@"\IO\Testfiles\Radians.txt", textwriter.ToString() );
			Assertion.AssertEquals("test 1",true,same);
		}
		...
		public void TestWriteVerticalDatum() 
		{
			...
			bool same = Compare.CompareAgainstString(Global.GetUnitTestRootDirectory()+@"\IO\Testfiles\VerticalDatum.txt", textwriter.ToString() );
			Assertion.AssertEquals("test 1",true,same);
		}
		...
		public void TestWriteDatum() 
		{
			...
			bool same = Compare.CompareAgainstString(Global.GetUnitTestRootDirectory()+@"\IO\Testfiles\HorizontalDatum.txt", textwriter.ToString() );
			Assertion.AssertEquals("test 1",true,same);
		}
		...
		public void TestWriteEllipsoid()
		{
			...
			bool same = Compare.CompareAgainstString(Global.GetUnitTestRootDirectory()+@"\IO\Testfiles\Spheroid.txt", textwriter.ToString() );
			Assertion.AssertEquals("test 1",true,same);
		}
		...
		public void TestWritePrimeMeridian()
		{
			...
			bool same = Compare.CompareAgainstString(Global.GetUnitTestRootDirectory()+@"\IO\Testfiles\PrimeMeridian.txt", textwriter.ToString() );
			Assertion.AssertEquals("test 1",true,same);
		}
		...
		public void TestWriteProjectedCoordinateSystem()
		{
			...
			bool same = Compare.CompareAgainstString(Global.GetUnitTestRootDirectory()+@"\IO\Testfiles\ProjectedCoordinateSystem.txt", textwriter.ToString() );
			Assertion.AssertEquals("test 1",true,same);
		}
		...
		public void TestWriteVerticalCoordinateSystem()
		{
			...
			bool same = Compare.CompareAgainstString(Global.GetUnitTestRootDirectory()+@"\IO\Testfiles\VerticalCoordinateSystem.txt", textwriter.ToString() );
			Assertion.AssertEquals("test 1",true,same);
		}
		...
		public void TestWrite1()
		{
			...
			bool same = Compare.CompareAgainstString(Global.GetUnitTestRootDirectory()+@"\IO\Testfiles\CompoundCoordinateSystem.txt", wkt );
			Assertion.AssertEquals("test 1",true,same);
		}
