...
/* 
 * $Header: /cvsroot/geotoolsnet/GeotoolsNet/Geotools.UnitTests/IO/CoordinateSystemWktReaderTest.cs,v 1.4 2005/10/20 16:36:12 awcoats Exp $
...
namespace Geotools.UnitTests.IO
{
	...
	public class CoordinateSystemWktReaderTest 
	{
		...
		public void TestReadUnit2() 
		{
			...
			bool same = Compare.CompareAgainstString(Global.GetUnitTestRootDirectory()+@"\IO\Testfiles\AngularUnit.txt",wkt2 );
		...
		{
			string testFile = Global.GetUnitTestRootDirectory()+@"\IO\Testfiles\LinearUnit.txt";
		...
		{
			string testFile = Global.GetUnitTestRootDirectory()+@"\IO\Testfiles\VerticalDatum.txt";
			string wkt1 = FileToString(testFile);
		...
		{
			string testFile = Global.GetUnitTestRootDirectory()+@"\IO\Testfiles\HorizontalDatum.txt";
			string wkt1 = FileToString(testFile);
		...
		{
			string testFile = Global.GetUnitTestRootDirectory()+@"\IO\Testfiles\Spheroid.txt";
			string wkt1 = FileToString(testFile);
		...
		{
			string testFile = Global.GetUnitTestRootDirectory()+@"\IO\Testfiles\PrimeMeridian.txt";
			string wkt1 = FileToString(testFile);
		...
		{
			string testFile = Global.GetUnitTestRootDirectory()+@"\IO\Testfiles\VerticalCoordinateSystem.txt";
			string wkt1 = FileToString(testFile);
		...
		{
			string testFile = Global.GetUnitTestRootDirectory()+@"\IO\Testfiles\ProjectedCoordinateSystem.txt";
			string wkt1 = FileToString(testFile);
		...
		{
			string testFile = Global.GetUnitTestRootDirectory()+@"\IO\Testfiles\CompoundCoordinateSystem.txt";
			string wkt1 = FileToString(testFile);
