...
/* 
 * $Header: /cvsroot/geotoolsnet/GeotoolsNet/Geotools.UnitTests/CoordinateSystems/DatumTest.cs,v 1.4 2005/10/20 16:29:42 awcoats Exp $
 * $Log: DatumTest.cs,v $
...
namespace Geotools.UnitTests.CoordinateSystems
{
	...
	public class DatumTest 
	{
		...
		{
			IDatum datum = new Datum(DatumType.IHD_Geocentric,"remarks","authority","authoritycode","name","alias","abbreviation");
			Assertion.AssertEquals("ctor 0. ", DatumType.IHD_Geocentric, datum.DatumType);
		...
		{
			IDatum datum = new Datum(DatumType.IHD_Geocentric);
			Assertion.AssertEquals("ctor 0. ", DatumType.IHD_Geocentric, datum.DatumType);
		}
	}
}
