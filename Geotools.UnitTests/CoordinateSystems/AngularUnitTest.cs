...
/* 
 * $Header: /cvsroot/geotoolsnet/GeotoolsNet/Geotools.UnitTests/CoordinateSystems/AngularUnitTest.cs,v 1.4 2005/10/20 16:29:42 awcoats Exp $
...
namespace Geotools.UnitTests.CoordinateSystems
{
	...
	public class AngularUnitTest 
	{
		...
		{
			IAngularUnit angularunit = new AngularUnit(1.0,"remarks","authority","authoritycode","name","alias","abbreviation");
		...
		{
			IAngularUnit angularunit = new AngularUnit(1.0);
