...
namespace Geotools.IO
{
	...
	public class DbaseFieldDescriptor
	{
        ...
        // fyrerise: added this override for debugging
        /// <summary>
        /// Returns a string that represents the descriptor for an easier time 
        /// debugging.
        /// </summary>
        public override string ToString()
        {
            return string.Format("{0} - {1}", Name, "LCDNFB".IndexOf(_type) != -1 ? Type.Name : "Unknown Type");
        }
