...
namespace Geotools.CoordinateTransformations
{
	...
	/// </summary>
	public class ReverseProjectionFilter : CoordinateFilter
	{
		...
		public ReverseProjectionFilter( ICoordinateTransformation projection )
		{
			if (projection==null)
			{
		...
		public void filter( Coordinate coord )
		{
			...
			CoordinatePoint projectedCoordinatePoint = _projection.MathTransform.GetInverse().Transform(this.CreateCoordinatePoint(coord));
